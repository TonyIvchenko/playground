"""Train huricaines rapid-intensification PyTorch model from real tracks."""
...
def train_model(
    ...
    weight_decay: float,
    seed: int,
) -> tuple[HuricainesMLP, torch.Tensor, torch.Tensor, float, float, float]:
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train huricaines PyTorch model from real data.")
    parser.add_argument(
        "--input-csv",
        type=Path,
