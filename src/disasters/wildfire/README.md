...
- `src/disasters/wildfire/data/raw/wildfire_training_merged.csv`
...
- optional artifact save back to `src/disasters/wildfire/model/wildfire_model.pt`
...
- processed training rows: `src/disasters/wildfire/data/processed/wildfire_training.csv`
- model artifact: `src/disasters/wildfire/model/wildfire_model.pt`
...
- `src/disasters/wildfire/tiles/overlay_cube.npz`
- `src/disasters/wildfire/tiles/overlay_config.json`
...
```bash
pytest -q src/disasters/wildfire/tests
```
