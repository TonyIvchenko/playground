"""Hurricane Gradio app with Google Maps risk overlay and inference form."""
...
<div id="hurricane-map-shell" class="risk-map-shell">
  <div class="risk-map-header">
    <label for="hurricane-year-slider"><strong>Year:</strong> <span id="hurricane-year-value">{start_year}</span></label>
    <input id="hurricane-year-slider" type="range" min="{start_year}" max="{end_year}" value="{start_year}" step="1" />
    <div class="risk-phase">Section: <span id="hurricane-phase">training</span></div>
  </div>
...
(() => {{
  ...
  const slider = root.querySelector("#hurricane-year-slider");
  const yearValue = root.querySelector("#hurricane-year-value");
  const phaseValue = root.querySelector("#hurricane-phase");
