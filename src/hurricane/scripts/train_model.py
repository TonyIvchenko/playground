"""Train hurricane rapid-intensification PyTorch model from real tracks."""
...
def train_model(
    ...
    learning_rate: float,
    seed: int,
) -> tuple[HurricaneMLP, torch.Tensor, torch.Tensor, float]:
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train hurricane PyTorch model from real data.")
    parser.add_argument(
        "--input-csv",
        type=Path,
    ...
    parser.add_argument(
        "--processed-csv",
        type=Path,
        default=Path("src/hurricane/data/processed/hurricane_training.csv"),
